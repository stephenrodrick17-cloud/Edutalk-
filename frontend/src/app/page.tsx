...
export default function Home() {
  return (
    <main className="relative flex min-h-screen flex-col items-center overflow-hidden">
      {/* Navbar */}
      <nav className="fixed top-0 z-50 flex w-full max-w-7xl items-center justify-between px-6 py-6 backdrop-blur-md">
        ...
        <div className="hidden items-center gap-8 md:flex">
          ...
          <Link href="#how-it-works" className="text-sm font-medium text-slate-400 transition-colors hover:text-white">How it works</Link>
          <Link href="/dashboard" className="rounded-full bg-blue-600 px-6 py-2.5 text-sm font-bold text-white transition-all hover:bg-blue-500 hover:shadow-lg hover:shadow-blue-500/20 uppercase tracking-widest">
            Enter Dashboard
          </Link>
        </div>
      </nav>
      ...
      <section className="relative flex w-full max-w-7xl flex-col items-center px-6 pt-32 pb-20 text-center md:pt-48 md:pb-32">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full -z-20 opacity-30 pointer-events-none">
           ...
           {/* Futuristic Chrome/Shattered Effect Background */}
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 rounded-full border border-rose-500/20 bg-rose-500/10 px-4 py-1.5 text-sm font-medium text-rose-400 mb-8"
        >
        ...
        <motion.div
         ...
         >
           <h1 className="text-7xl font-black tracking-tighter md:text-9xl uppercase leading-none text-white mix-blend-difference shattered-text">
             Shattered
           </h1>
           <div className="absolute -top-4 -right-4 h-24 w-24 rounded-full border border-rose-500/30 animate-pulse" />
        ...
        >
          not every darkness needs light some even glass <br/>
          were born to consume bleeds when it shatters <br/>
          <span className="text-rose-500/50">bleeding light from the cracks</span>
        </motion.p>
        ...
        >
          <Link href="/dashboard" className="group flex h-14 items-center gap-2 rounded-none border border-white bg-white px-8 text-sm font-bold uppercase tracking-widest text-black transition-all hover:bg-transparent hover:text-white">
            Access System
            <ArrowRight className="h-5 w-5 transition-transform group-hover:translate-x-1" />
          </Link>
          <Link href="/dashboard/upload" className="flex h-14 items-center rounded-none border border-white/20 bg-transparent px-8 text-sm font-bold uppercase tracking-widest transition-all hover:bg-white/5">
            Analyze Paper
          </Link>
        </motion.div>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                className={cn(
                  "relative group overflow-hidden rounded-none border border-white/10 bg-slate-950 p-1 transition-all duration-500",
                  card.rotate,
              ...
              >
                <div className="relative aspect-[4/5] overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 h-4 w-4 border-l border-t border-rose-500/50" />
          ...
          <motion.div 
            ...
            className="absolute -top-10 -right-10 hidden lg:block p-4 border border-white/10 bg-slate-950/50 backdrop-blur-md font-mono text-[10px] text-blue-400"
          >
      ...
      <section id="features" className="w-full max-w-7xl px-6 py-20 bg-slate-950/50 backdrop-blur-3xl border-y border-white/5">
        <div className="mb-20 text-center">
           ...
           <div className="h-1 w-20 bg-rose-600 mx-auto" />
        </div>
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-2">
          {[
            ...
            >
              <div className="relative w-full md:w-1/2 aspect-video overflow-hidden border border-white/10">
                 <img 
                   src={feature.img} 
                   alt={feature.title}
              ...
              <div className="w-full md:w-1/2 space-y-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-none border border-rose-500/50 text-rose-400 group-hover:bg-rose-600 group-hover:text-white transition-all">
