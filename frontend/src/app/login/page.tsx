...
import { BrainCircuit, Mail, Lock, ArrowRight, Globe } from "lucide-react";
    ...
    <div className="flex min-h-screen items-center justify-center p-6">
      ...
      >
        <div className="text-center">
          ...
          <p className="mt-2 text-slate-400">Sign in to continue your exam preparation</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" className="h-4 w-4 rounded border-white/10 bg-white/5 accent-blue-600" />
        ...
        <p className="text-center text-sm text-slate-500">
          Don't have an account? <Link href="/signup" className="text-blue-400 hover:text-blue-300 font-medium">Create account</Link>
        </p>
      </motion.div>
    </div>
  );
