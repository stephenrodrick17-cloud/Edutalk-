...
export default function PlannerPage() {
  ...
  const handleRegenerate = () => {
    ...
    setTimeout(() => {
      ...
      // In a real app, this would fetch a new plan from the backend
    }, 2000);
  };
    ...
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-slate-400">AI-optimized schedule based on topic frequency and your weak areas.</p>
        </div>
           ...
           <div className="rounded-3xl border border-white/5 bg-white/5 p-6">
              ...
              <div className="space-y-4">
                 <div className="p-4 rounded-2xl bg-blue-600/10 border border-blue-500/20">
                    ...
                    <p className="text-sm text-slate-300 leading-relaxed">Prioritizing <b>Unit 3</b> and <b>Unit 5</b> as they account for 45% of historical marks.</p>
                 </div>
                 <div className="p-4 rounded-2xl bg-emerald-600/10 border border-emerald-500/20">
                    <p className="text-xs font-bold text-emerald-400 uppercase tracking-widest mb-1">Status</p>
                    <p className="text-sm text-slate-300 leading-relaxed">You are <b>2 days ahead</b> of your original schedule. Keep it up!</p>
                 </div>
              </div>
           </div>
